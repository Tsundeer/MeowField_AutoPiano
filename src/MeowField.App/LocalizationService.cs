...
public static class LocalizationService
{
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["播放参数"] = "Playback parameters", ["目标窗口"] = "Target window", ["刷新窗口"] = "Refresh windows", ["输入方式"] = "Input mode", ["乐器"] = "Instrument", ["和弦处理"] = "Chord handling", ["速度"] = "Speed", ["转调"] = "Transpose", ["最大复音"] = "Max polyphony", ["链路补偿"] = "Link compensation", ["优先映射最近白键"] = "Prefer nearest white key", ["载入时自动移调"] = "Auto transpose on load", ["播放队列"] = "Play queue", ["自动下一首"] = "Auto play next", ["上一首"] = "Previous", ["下一首"] = "Next", ["移出队列"] = "Remove from queue", ["清空队列"] = "Clear queue", ["上移"] = "Move up", ["下移"] = "Move down", ["停止"] = "Stop",
